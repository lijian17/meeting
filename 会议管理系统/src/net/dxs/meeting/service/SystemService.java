...
public class SystemService extends Service {
	...
	public void onStart(Intent intent, int startId) {
		...
		pendIntent = PendingIntent.getBroadcast(getApplicationContext(), 0, intent1, 0); // 获取一个将执行广播事件的PendingIntent

		alarmManager.setRepeating(AlarmManager.RTC_WAKEUP, currentTime, interValue, pendIntent); // 根据设定的时间间隔不断的发送广播事件
	}
